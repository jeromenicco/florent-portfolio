...
import DD3 from "./assets/images/DATADRAMA/DATADRAMA3.jpg"
import DD4 from "./assets/images/DATADRAMA/DATADRAMA4.jpg"
import DD5 from "./assets/images/DATADRAMA/DATADRAMA5.jpg"
...
export const projectList = [
  {
    ...
    resume: "Le magazine qui explore le futur, trimestriellement.",
    resumeItalic: "Direction artistique, design éditorial.",
    img: [UR1, UR2, UR3, UR4, UR5, UR6, UR7],
  },
  {
    title: "DATADRAMA",
    resume: "Roman graphique de science-fiction sur la technologie et la pornographie. Projet en cours.",
    resumeItalic: "Écriture, illustrations digitales, expérimentations graphiques.",
    img: [DD1, DD2, DD3, DD4, DD5],
  },
  {
    title: "F.I.F.85",
    resumeItalic: "Direction artistique, typographie.",
    img: [FIF1, FIF2, FIF3, FIF4, FIF5],
  },
  {
    title: "The Final Countdown",
    resume: "Talk-show en ligne d’ArianeGroup au sujet de l’actualité spatiale.",
    resumeItalic: "Direction artistique, habillage graphique, motion design.",
  ...
  },
  {
    ...
    resumeItalic: "Direction artistique, design éditorial, illustration.",
    img: [LAC1, LAC2, LAC3, LAC4],
  },
  {
    title: "Podcasts",
    resume: "Les 5 émissions d’Usbek & Rica.",
    resumeItalic: "Direction artistique, réseaux sociaux.",
  ...
  {
    title: "Konbini x N26",
    resume: "Vidéo explicative retraçant l’histoire des néobanques.",
